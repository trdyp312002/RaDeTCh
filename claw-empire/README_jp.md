...
- **API モデル割り当ては development を起点に、初期セットアップ済みの office pack まで広がります** - `development` を既定の基準線として保ちつつ、すでに hydrate 済みの office pack も割り当て対象に含まれます。
...
- assign モーダルは `development` を既定の基準線として使い、初期セットアップが完了して hydrate 済みの office pack もあわせて表示します。
